 ...
 * Projects Model
 *
 * @property \App\Model\Table\ProjectHeartsTable&\Cake\ORM\Association\HasMany $ProjectHearts
 *
...
class ProjectsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('imageThumbnail')
            ->maxLength('imageThumbnail', 64)
            ->allowEmptyFile('imageThumbnail');
